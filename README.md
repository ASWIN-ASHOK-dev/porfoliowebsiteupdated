# Aswin Ashok — Portfolio

Portfolio site for Aswin Ashok. Contains projects, CV, and blog.
...
- **GENERATE_SLUG_FROM_TITLE**: By default, blog slugs are generated from the article title. Set this to false if you prefer Astro file-based slugs.
...
If you want to contribute or file issues, please open them in this repository.
